...
- (void)willRotateToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation duration:(NSTimeInterval)duration
{
    ...
    CGRect rc =self.view.superview.frame;
    if (isLandscape) {
        [self.view setFrame:CGRectMake(rc.origin.x, rc.origin.y, rc.size.height, rc.size.width)];
    }
    else
    {
...
//    CGFloat barHeight = 0;
    ...
    //_toolbar.autoresizingMask = 0xffffffff ;
...
- (void)showPhotoViewAtIndex:(int)index
{
    ...
    //大图片居中显示
    [photoView scrollViewDidZoom:photoView];
